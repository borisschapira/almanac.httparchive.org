...
title: SEO
description: Chapitre SEO du Web Almanac 2020 couvrant le contenu, les meta tags, l'indexabilité, les liens, la vitesse, les données structurées, l'internationalisation, les SPA, l'AMP et la sécurité.
...
aleyda_bio: Consultant en référencement, auteur, conférencier et entrepreneur. Fondateur de <a href="https://www.orainti.com/" hreflang="en">Orainti</a> (une agence de conseil en référencement travaillant avec certaines des meilleures enseignes et marques du Web, du SaaS aux places de marché) et co-fondateur de <a href="https://remoters.net/" lang="en" hreflang="en">Remoters.net</a> (un portail gratuit de travail à distance), proposant des emplois en télétravail, des outils, des événements, des guides, etc. pour faciliter le travail à distance. Aleyda aime partager sur le référencement à travers son <a href="https://www.aleydasolis.com/en/blog/" hreflang="en">blog</a>, la <a href="https://www.aleydasolis.com/en/seo-tips/" hreflang="en">newsletter #SEOFOMO</a>, la série de vidéos et podcasts <a href="https://www.aleydasolis.com/en/crawling-mondays-videos/" lang="en" hreflang="en">Crawling Mondays</a> et sur <a href="https://twitter.com/aleyda">Twitter</a>.
ipullrank_bio: Tout à la fois artiste et technicien, Michael King est le fondateur de l'agence de marketing numérique <a href="https://ipullrank.com" lang="en" hreflang="en">iPullRank</a> et de l'application de génération automatique de textes <a href="https://www.copyscience.io" lang="en" hreflang="en">CopyScience</a>. S'appuyant sans effort sur son passé de musicien hip-hop indépendant, M. King est un créateur de contenu convaincant et un orateur dynamique primé qui est invité à participer à des conférences et des blogs sur la technologie et le marketing dans le monde entier. Vous pouvez retrouver le franc parler de Mike sur <a href="https://twitter.com/ipullrank">Twitter</a>.
fellowhuman1101_bio: 100 % humain et pas du tout un robot, Jamie Indigo démêle les technologies pour aider les humains à accéder à des informations utiles et les entreprises à fournir des expériences numériques précieuses. Elle a fondé <a href="https://not-a-robot.com" lang="en" hreflang="en">Not a Robot</a> pour conseiller en mettant l'accent sur les aspects humains du référencement technique, y compris l'éthique et l'inclusion dans le secteur de la technologie et de la recherche.  Vous pouvez la retrouver en train de s’instruire sur <a href="https://twitter.com/Jammer_Volts">Twitter</a>.
discuss: 2043
results: https://docs.google.com/spreadsheets/d/1ram47FshAjzvbQVJbAQPgxZN7PPOPCKIK67VJZCo92c/
featured_quote: Malgré l'utilisation croissante des appareils mobiles et le passage de Google à un index priorisant l’expérience mobile, des disparités non négligeables ont été constatées entre les pages pour téléphones portables et celles pour ordinateurs de bureau, comme entre les liens des téléphones portables et ceux des ordinateurs de bureau.
featured_stat_1: 10,84 %
featured_stat_label_1: des pages pour mobiles n'incluent pas la balise viewport
featured_stat_2: 19,96 %
featured_stat_label_2: des sites web mobiles ont obtenu la mention « bon » dans les Signaux Web Essentiels
featured_stat_3: 11,5 %
featured_stat_label_3: de mots supplémentaires sont affichés dans le rendu par rapport au HTML brut du site mobile médian
---
